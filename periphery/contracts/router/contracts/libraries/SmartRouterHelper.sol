...
library SmartRouterHelper {
    ...
    // bytes32 internal constant V2_INIT_CODE_HASH = 0x0100045707a42494392b3558029b9869f865ff9df8f375dc1bf20b0555093f43; // zksync
    bytes32 internal constant V2_INIT_CODE_HASH = 0x0100045707a42494392b3558029b9869f865ff9df8f375dc1bf20b0555093f43;
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        //     )
        // );
        bytes32 senderBytes = bytes32(uint256(uint160(factory)));
        bytes32 data = keccak256(
            abi.encodePacked(
                CREATE2_PREFIX,
                senderBytes,
                keccak256(abi.encodePacked(token0, token1)),
                V2_INIT_CODE_HASH, // pair bytecode hash
    ...
    bytes32 internal constant V3_INIT_CODE_HASH = 0x01001465a2a6a5e20ea18dcffab2f1a9e002283d7a7753a05ea2202965d2d9e4;
    ...
    function computeAddress(address deployer, PoolKey memory key) internal pure returns (address pool) {
        ...
        //     )
        // );
        bytes32 senderBytes = bytes32(uint256(uint160(deployer)));
        bytes32 data = keccak256(
            abi.encodePacked(
                CREATE2_PREFIX,
                senderBytes,
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) internal pure returns (IPancakeV3Pool) {
