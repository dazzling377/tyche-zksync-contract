...
import NftDescriptorOffchainArtifact from '../../artifacts-zk/contracts/v3-periphery/contracts/NonfungibleTokenPositionDescriptorOffChain.sol/NonfungibleTokenPositionDescriptorOffChain.json'
